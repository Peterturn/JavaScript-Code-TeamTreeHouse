...
if(parseInt(num)>0){
  ...
  console.log("The number of " + product.name + "(s) after addition of " + num+ " to invatory has increased to a total of " + product.inventory +"." );
    }
  }
...
In this example, "chair" is the name of the product.
*/
function processSale(num2){
  var totalSales= parseInt(num2)*parseInt(product.unit_price);
  if(parseInt(num2)>0){
    product.inventory-=num2;

    console.log("The number of " + product.name + "(s) after removal from " + num2+ "  invatory has decreased to a total of " + product.inventory +"." );
    console.log("The number of " + product.name + "(s) sold is " + num2+ "  for the sum total of $" + totalSales +"." );
      }
